        ...
        <div class="container">
            ...
            <div class="rowC">
                <div class="columnC">
                    ...
                    <button type="submit" class="changepic">change image </button>
                </div>
                <div class="columnC">
                    <form action="/action_page.php">
                        <label for="fname">New Item name</label>
                        <input class="inputCo" type="text" id="fname" name="firstname" placeholder="Item name">
                        <label for="lname">New Price:</label>
                        <input class="inputCo" type="text" id="lname" name="lastname" placeholder="Price: ">
                        <br>
                        <label for="subject">New Description</label>
                        <textarea id="subject" name="subject" placeholder="Food descriptions"
